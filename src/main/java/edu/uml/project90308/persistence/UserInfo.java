...
public class UserInfo {
     ...
     * @param symbols An ArrayList of stock symbols the user is tracking
     */
    public Userinfo(String name, String password, ArrayList<String> symbols) {
        this.userName = name;
    ...
    public static getUserAccount(String username, password){
